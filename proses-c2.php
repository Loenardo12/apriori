...
<h2 class="art-postheader">Data Proses C2</h2>
...
<tr style="background:linear-gradient(to top, #CCC, #999 );">
  <td colspan="6"><br /><a style="padding:3px 8px 3px 8px; border:1px solid #06F; background:linear-gradient(to top, #099, #0C9);"  href="hal_admin.php?page=c2tes">Lanjutkan Proses C2</a></td>
</tr>
<tr style="background:linear-gradient(to top, #CCC, #999 );">
